...
| void | **[render](/docs/classes/classQskGraphic/#function-render)**(QPainter * painter, const QRectF & rect, const QskColorFilter & colorFilter, Qt::AspectRatioMode aspectRatioMode =Qt::IgnoreAspectRatio) const |
